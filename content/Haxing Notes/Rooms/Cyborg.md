...
tar xzf archive.tar  
go to final_archive, see README, go to website, find borg extract
 
borg extract <pwd>/data::music_archive  
...
/home/alex/user.txt  
sudo -l  
cat backup.sh; see it gets -c cmd as argument then executes it.  
...
Authorization: Basic bXVzaWNfYXJjaGl2ZQo=:LlEuMW0uCg==
    
BELOW IS CHECKSUM OF BORG REPO:  
[repository]  
version = 1  
...
hint:  
��version�segments�d�compact��storage_quota_use��  
��version�hints�@{"algorithm": "XXH64", "digests": {"final": "05178884e81563d7"}}�index�b{"algorithm": "XXH64", "digests": {"HashHeader": "146e9cb969e480a3", "final": "b53737af67235823"}}  
nonce:  
00000000200000b9